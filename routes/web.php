...
Route::prefix('admin')->middleware(['auth','isAdmin'])->group(function () {
    ...
    Route::get('/employee/order', [App\Http\Controllers\Admin\EmployHisController::class, 'order'])->name('inventories');
    Route::get('/employee/purchase', [App\Http\Controllers\Admin\EmployHisController::class, 'purchase'])->name('inventories');
